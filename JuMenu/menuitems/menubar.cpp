...
*/
void JuMenu::MenuBar::Init(std::vector<SingleBarMenuItem> &baritems,Properties &props)
{
...
*/
JuMenu::BarSelection JuMenu::MenuBar::UpdateBarEvents(InputStruct &input)
{
    BarSelection select;
