...
*/
void JuMenu::MenuIcons::Init(Properties *props)
{
...
*/
void JuMenu::MenuIcons::DrawIcons()
{
...
*/
void JuMenu::MenuIcons::DefineNewIcon(float x,float y,std::string iconimage,float scale)
{
    float xpos=x;
    float ypos=y;
...
*/
void JuMenu::MenuIcons::UpdateIconEvents(InputStruct &input)
{
...
active if it is.
*/
void JuMenu::MenuIcons::CheckMouseOver(float x, float y)
{
    hovericon=-1;
...
*/
void JuMenu::MenuIcons::CheckPress(bool press,int IconID)
{
    //int RTNID=-1;
    if(IconID>=0 && press)
    {
...
this class.
*/
void JuMenu::MenuIcons::ResetIconStates()
{
...
*/
int JuMenu::MenuIcons::GetActiveIcon()
{
    return activeicon;
};
