...
public:
    ...
    // Constructor
    MenuButtons ( bool reqsat,std::string ident,std::string &dstr,Properties *props,ISoundEngine* audioengine )
        : reqsat(false),ident(ident),props(props),audioengine(audioengine) {
