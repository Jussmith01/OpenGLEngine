...
*/
void JuMenu::DisplayBox::SetColors(glm::vec4 bkgcolor,glm::vec4 bdrcolor)
{
...
*/
void JuMenu::DisplayBox::DrawBox()
{
    // Activate shader
    shader.Use();
...
/*
*/
void JuMenu::DisplayBox::DrawBoxPos(float x,float y)
{
    // Activate shader
    shader.Use();
...
*/
void JuMenu::DisplayBox::Cleanup()
{
...
*/
void JuMenu::DisplayBox::SetupBackground ()
{
...
*/
void JuMenu::DisplayBox::SetupBorder ()
{
