...
*/
void JuMenu::MenuButtons::DefineNewButton(std::string caption,float x, float y,bool active)
{
    float xpos=x;
    float ypos=y;
...
active if it is.
*/
void JuMenu::MenuButtons::CheckMouseOver(float x, float y)
{
    hoverbutton=-1;
...
*/
void JuMenu::MenuButtons::CheckPress(bool press,int ButtonID)
{
    if(ButtonID>=0 && press)
    {
