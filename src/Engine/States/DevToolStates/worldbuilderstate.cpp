...
void WorldBuilderState::Init(GrafixEngine *game)
{
...
void WorldBuilderState::Resume(GrafixEngine* game)
{

};

void WorldBuilderState::HandleEvents(GrafixEngine* game)
{
    glfwPollEvents();
...
void WorldBuilderState::Update(GrafixEngine* game)
{
    dt=glfwGetTime()-dt;
...
void WorldBuilderState::Draw(GrafixEngine* game)
{
    // Render
