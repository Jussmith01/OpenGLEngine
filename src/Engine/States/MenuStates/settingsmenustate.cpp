...
void SettingsMenuState::Init(GrafixEngine *game)
{
...
void SettingsMenuState::Resume(GrafixEngine* game)
{

};

void SettingsMenuState::HandleEvents(GrafixEngine* game)
{
    glfwPollEvents();
...
void SettingsMenuState::Update(GrafixEngine* game)
{
    dt=glfwGetTime()-dt;
};

void SettingsMenuState::Draw(GrafixEngine* game)
{
    // Render
