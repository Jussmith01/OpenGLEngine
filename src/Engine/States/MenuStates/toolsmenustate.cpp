...
void ToolsMenuState::Init(GrafixEngine *game)
{
...
void ToolsMenuState::Resume(GrafixEngine* game)
{

};

void ToolsMenuState::HandleEvents(GrafixEngine* game)
{
    glfwPollEvents();
...
void ToolsMenuState::Update(GrafixEngine* game)
{
    dt=glfwGetTime()-dt;
};

void ToolsMenuState::Draw(GrafixEngine* game)
{
    // Render
