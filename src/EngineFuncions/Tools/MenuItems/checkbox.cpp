...
*/
void MenuCheckBox::Init(std::string boximage,std::string boxsound,
...
*/
void MenuCheckBox::Set(bool State)
{
    checked=State;
};
...
*/
void MenuCheckBox::SetUnchecked()
{
    checked=false;
};
...
*/
void MenuCheckBox::DrawCheckBox(double x,double y)
{
    // Draw
...
*/
void MenuCheckBox::UpdateCheckBoxEvents(InputStruct &input)
{
    double xmp,ymp;
...
active if it is.
*/
bool MenuCheckBox::CheckMouseOver(float xmp,float ymp)
{
    // Check X over
    bool xchk=false;
    float xl=x-lw;
...
*/
bool MenuCheckBox::CheckedState()
{
    // Return Result
    return checked;
};
