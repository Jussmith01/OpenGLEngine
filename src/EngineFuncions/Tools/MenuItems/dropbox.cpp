...
*/
void MenuDropBox::Init(std::string boximage,std::string boxsound,
...
*/
void MenuDropBox::SetColors(glm::vec3 c1,glm::vec3 c2,glm::vec4 c3,glm::vec4 c4,glm::vec4 c5,glm::vec4 c6)
{
    textcolor[0]=c1;
    textcolor[1]=c2;
...
*/
void MenuDropBox::SetSelection(int i)
{
    selection=i;
};
...
*/
void MenuDropBox::UpdateDropBoxEvents(InputStruct &input)
{
    double xmp,ymp;
...
active if it is.
*/
bool MenuDropBox::CheckMouseOver(float xmp,float ymp)
{
    // Check X over
    bool xchk=false;
    float xl=x-lw;
...
active if it is.
*/
int MenuDropBox::CheckMouseOverSelection(float xmp,float ymp)
{
    int rtnmo=selection;
    for(int i=0; i<(int)data.size(); ++i)
    {
...
*/
int MenuDropBox::SelectionState()
{
    // Return Result
    return selection;
};
