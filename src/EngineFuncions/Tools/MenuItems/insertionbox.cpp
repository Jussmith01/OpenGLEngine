...
*/
void InsertionBox::Init(float posx,float posy,float width,std::string sound,Properties &props,ISoundEngine* audioengine,int keyset)
{
...
*/
void InsertionBox::SetData(std::string data)
{
    this->data=data;
};
...
*/
void InsertionBox::UpdateEvents(InputStruct &input)
{
    double xmp,ymp;
...
active if it is.
*/
bool InsertionBox::CheckMouseOver(float xmp,float ymp)
{
    // Check X over
    bool xchk=false;
    float xl=x-lw;
...
*/
void InsertionBox::SetNumericalValues(InputStruct &input)
{
...
*/
float InsertionBox::FetchDataFloat()
{
...
Fetch the Data of float
*/
int InsertionBox::FetchDataInteger()
{
...
Fetch the Data of float
*/
std::string InsertionBox::FetchDataString()
{
    return data;
};
